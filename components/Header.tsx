...
import { Menu, X, Globe, Search, Flame, Facebook, Send, Instagram, Youtube, Moon, Sun, Radio, Tv } from 'lucide-react'
...
export default function Header() {
  ...
  return (
    <>
      ...
      {/* Main Navigation Bar */}
      <header className="bg-blue-900 dark:bg-blue-950 text-white sticky top-[41px] z-40 border-b border-blue-800">
        <div className="container mx-auto px-4 max-w-7xl">
